...
uicontrol(hplanta,...
    'Style','edit',...
    'Units','normalized',...
    'Position',[0.37 0.805 0.2 0.1],...
    'BackgroundColor',get(hf,'Color'),...
    'String','0' ,...
    'HorizontalAlignment', 'center',...
    'HandleVisibility','callback',...
    'Callback', @cb_changeCOMPort,...
    'Tag', 'porta');

uicontrol(hplanta,...
    'Style','pushbutton',...
    'Units','normalized',...
    'Position',[0.6 0.8 0.35 0.15],...
    'BackgroundColor',get(hf,'Color'),...
    'String','Conectar' ,...
    'HorizontalAlignment', 'center',...
    'HandleVisibility','callback',...
    'Callback', @cb_connectDisconnect,...
    'Tag', 'porta');
...
uicontrol(hplanta,...
    ...
    'HorizontalAlignment', 'center',...
    'HandleVisibility','callback',...
    'Callback', @cb_ligaMotor,...
    'Tag', 'bt_ligaMotor');

sld = uicontrol(hplanta,...
        'Style', 'slider',...
        'Units','normalized',...
        'BackgroundColor',get(hf,'Color'),...
        'Min',0,'Max',253,'Value',0,...
        'Position',[0.1 0.35 0.8 0.15],...
        'Callback', @cb_changePwm); 
...
textos = {'Posição do Carrinho','Velocidade do Carrinho', 'Posição do Pêndulo','Velocidade do Pêndulo','Atuação'};
largura = 0.1;
...
caixa = uicontrol(hf,...
    ...
    'HorizontalAlignment', 'center',...
    'HandleVisibility','callback',...
    'Tag', 'box_n_simulations',...
    'Callback', @cb_change_max_curves);
...
linha2DLimiteFisicoInf = line('Parent', ha_visu,...
    'XData',[-50 -50],...
    'YData',[-7 7],...
    'LineWidth', 3,...
    'Color','black');

linha2DLimiteFisicoSup = line('Parent', ha_visu,...
    'XData',[50 50],...
    'YData',[-7 7],...
    'LineWidth', 3,...
    'Color','black');
...
ad.linhas = {};
ad.modelo2D = [linha2DTrilho linha2DCarro linha2DPendulo linha2DLimiteFisicoInf linha2DLimiteFisicoSup];
ad.simulando = 0; % Não está simulando
ad.pausado = 0; % Não está pausado
ad.referencia = 0; % Temporário
ad.nextColor = 1; % Próxima cor de gráfico
ad.Nmax = 1; % Máximo de curvas nos graficos
ad.pendPert = 0; % Não há pert no pendulo ou carrinho
ad.cartPert = 0;
ad.COMPort = 0; % Porta de conexão
ad.serialObject = [];
